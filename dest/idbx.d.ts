...
export declare function addBulk<T>(store: IDBObjectStore, items?: T[], key?: IDBValidKey): Promise<IDBValidKey[]>;
export declare function put<T>(store: IDBObjectStore, item: T, key?: IDBValidKey): Promise<IDBValidKey>;
export declare function putBulk<T>(store: IDBObjectStore, items?: T[], key?: IDBValidKey): Promise<IDBValidKey[]>;
...
export declare function get<T>(store: IDBObjectStore, query: IDBValidKey): Promise<T | undefined>;
